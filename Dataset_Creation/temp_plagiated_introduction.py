...
def paraphrase_introduction_in_file(input_file_path, output_file_path):
    ...
    for i, line in enumerate(content):
        if line.strip().lower().startswith("1 introduction") or line.strip().lower().startswith("1. introduction"):
            introduction_start_index = i
        elif line.strip().lower().startswith("2") or line.strip().lower().startswith("2."):
            introduction_end_index = i
            break
    
    # If 'Introduction was found, paraphrase it 
