...
df = pd.read_csv('Test_on_multiplagiated_paper/Ai_Detection/Ai_Detection_result_multiplagiated.csv')


#load document 
pdf_folder='Test_on_multiplagiated_paper/multiplagiated_pdf'
...
for i in tqdm.tqdm(range(len(df))):
    ...
    print(input_pdf)
    output_pdf='Test_on_multiplagiated_paper/annotation_on_pdf_multiplagiated/annotated_pdf_multiplagiated'+'/'+df.iloc[i]['plagiated_file'].replace('.xml','_highlight.pdf')
    print(output_pdf)
