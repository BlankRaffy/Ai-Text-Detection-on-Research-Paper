...
df_abstract = pd.read_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top-k_rank/top_abstract_scores.csv').groupby('input_file')
df_intro = pd.read_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top-k_rank/top_intro_scores.csv').groupby('input_file')
df_conclusion = pd.read_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top-k_rank/top_conclusion_scores.csv').groupby('input_file')
