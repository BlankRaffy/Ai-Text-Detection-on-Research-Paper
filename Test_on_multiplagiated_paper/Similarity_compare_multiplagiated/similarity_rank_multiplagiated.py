...
top_abstracts_df.to_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top-k_rank/top_abstract_scores.csv', index=False)
top_intros_df.to_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top-k_rank/top_intro_scores.csv', index=False)
top_conclusions_df.to_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top-k_rank/top_conclusion_scores.csv', index=False)
