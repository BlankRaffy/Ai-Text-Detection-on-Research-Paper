...
top_abstracts_df.to_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top_k_for_yake/top_abstract_scores.csv', index=False)
top_intros_df.to_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top_k_for_yake/top_intro_scores.csv', index=False)
top_conclusions_df.to_csv('Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/top_k_for_yake/top_conclusion_scores.csv', index=False)
