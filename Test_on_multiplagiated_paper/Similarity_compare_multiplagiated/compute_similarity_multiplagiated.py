...
df_plagiated= pd.read_csv('Test_on_multiplagiated_paper/topic_extraction_multiplagiated/topic_extracted_for_multiplagiated.csv', converters={'abstract': convert_to_list, 'introduction': convert_to_list, 'conclusion': convert_to_list})
...
csv_file_path = 'Test_on_multiplagiated_paper/Similarity_compare_multiplagiated/dataset_topic_compare_multiplagiated.csv'
