...
output_folder='Test_on_multiplagiated_paper/multi_plagiated_paper'
...
df_multi_plagiated_source.to_csv('Test_on_multiplagiated_paper/multiplagiated_source.csv',index=False)
