...
columns = ['input_file','compare_file','abstract_semantic_score','intro_semantic_score','conclusion_semantic_score']
...
csv_file_path = 'Test_on_multiplagiated_paper/semantic_similarity/semantic_on_all_file_all_part.csv'
